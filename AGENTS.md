...
5. Read `memory/self-review.md` — your metacognitive log of MISS/FIX patterns
   - Prioritize recent MISS entries
   - When task context overlaps a logged MISS → force counter-check before responding
